          ...
          <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <div className="mt-3 flex select-none flex-wrap items-center gap-1">
              <label className="">
                ...
                <p className="peer-:bg-black peer-:text-white rounded-lg border border-black px-6 py-2 font-bold">Black</p>
              </label>
              <label className="">
                <input type="radio" name="type" value="Whole Bean" className="peer sr-only" />
                <p className="peer-:bg-black peer-:text-white rounded-lg border border-black px-6 py-2 font-bold">White</p>
              </label>
              <label className="">
                <input type="radio" name="type" value="Groud" className="peer sr-only" />
                <p className="peer-:bg-black peer-:text-white rounded-lg border border-black px-6 py-2 font-bold">Gray</p>
              </label>
            </div>
            ...
            <div className="mt-3 flex select-none flex-wrap items-center gap-1">
              <label className="">
                ...
                <p className="peer-:bg-black peer-:text-white rounded-lg border border-black px-6 py-2 font-bold">128 gb</p>
              ...
              <label className="">
                ...
                <p className="peer-:bg-black peer-:text-white rounded-lg border border-black px-6 py-2 font-bold">256 gb</p>
              ...
              <label className="">
                ...
                <p className="peer-:bg-black peer-:text-white rounded-lg border border-black px-6 py-2 font-bold">512 gb</p>
          ...
          <div className="lg:col-span-3">
            <div className="border-b border-gray-300">
              <nav className="flex gap-4">
                <Link to="#" title="" className="border-b-2 border-gray-900 py-4 text-sm font-medium text-gray-900 hover:border-gray-400 hover:text-gray-800"> Description </Link>
    
                <Link to="#" title="" className="inline-flex items-center border-b-2 border-transparent py-4 text-sm font-medium text-gray-600">
                  Reviews
